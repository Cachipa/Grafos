...
def Funcao2():
    if Lista1.get() != "" and Lista2.get() != "":
        ...
        pos = nx.get_node_attributes(h, 'pos')
        plt.figure()
        nx.draw(h, pos, labels=nomes2, with_labels=True, edge_color=colors, node_color=ndcolor, **node_label_options, **node_options, **edge_options)
...
def Funcao5():
    ...
    text = Label(top5,text=h2l).grid(row=1, column=0)
